...
<body>
            ...
            <?php foreach ($data["Pizzas"] as $pizza) { ?>
                <div class="col-4">
                    <div class="card" style="height: 23rem; margin-bottom: 2rem;">
                        <img src="<?= URLROOT . $pizza->pizzaImage ?>" class="card-img-top" alt="<?= $pizza->pizzaName ?>" style="width: 100%; height: 10rem;">
                        <div class="card-body">
    ...
    <div class="shopping-cart hidden">
        <div class="cart-content">
            ...
            <button class="checkout-button" id="checkout-button" style="display: none;">Checkout</button>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item <?= ($data['pageNumber'] <= 1) ? 'disabled' : ''; ?>">
                <a class="page-link" href="<?= URLROOT . '/dashboardcontroller/index/' . ($data['pageNumber'] - 1) ?>">Previous</a>
            </li>
            ...
            <li class="page-item <?= ($data['pageNumber'] >= $data['totalPages']) ? 'disabled' : ''; ?>">
                <a class="page-link" href="<?= URLROOT . '/dashboardcontroller/index/' . ($data['pageNumber'] + 1) ?>">Next</a>
            </li>
        </ul>
    </nav>
